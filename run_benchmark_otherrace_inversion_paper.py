...
def run_single_model(model_name, export_path, layers_to_extract=None, model_path=None):
    ...
    elif layers_to_extract[0] == 'all':
        # Use all available layers if 'all' is specified
        print(f"Using all available layers: {available_layers}")
        layers_to_extract = available_layers
    else:
    ...
    lfw_images_inverted = '/home/new_storage/experiments/ng_otherrace_inversion_diff_exp_models/additional_tests_datasets/LFW/lfw-align-128_inverted'
    ...
    other_race_images_inverted_folder_path = '/home/new_storage/experiments/ng_otherrace_inversion_diff_exp_models/additional_tests_datasets/other_race/other_raceLabMtcnn_inverted'
    ...
    tasks = [
        ...
        # ),
        AccuracyTask(
            task_name='LFW_inverted',
            pairs_file_path=lfw_pairs,
            images_folder_path=lfw_images_inverted,
            distance_function=cosine_distances,
            true_label='same'
        ),
        AccuracyTask(
            pairs_file_path = asian_pairs_path,
            images_folder_path = other_race_images_inverted_folder_path,
            true_label = 'same',
            distance_function = pairwise.cosine_distances,
            task_name = 'Other Race Effect - Asian - Inverted'
        )
    ]
...
if __name__ == '__main__':
    ...
    if exp_id_tradeoff_MR:
        ...
        all_ids = [10, 5, 2]  #[1000, 500, 200, 100, 50, 10, 5, 2]
        all_img_per_id = [300, 200, 100, 50, 20, 10, 5, 1]   # [300, 200, 100, 50, 20, 10, 5, 1] 
            ...
            for img_per_id in all_img_per_id:
                ...
                for model_path_index in range(len(model_paths)):
                    ...
                    try:
                        ...
                        print(f"Error processing model {model_paths[model_path_index]}: {e}")
                        continue
